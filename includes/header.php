    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="/dprd_website/input_agenda_dprd/daftar_agenda.php" class="<?php echo (strpos($_SERVER['REQUEST_URI'], '/input_agenda_dprd/') !== false) ? 'active' : ''; ?>">Daftar Agenda Rapat</a></li>
